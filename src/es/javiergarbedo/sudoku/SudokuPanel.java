    ...
    public void paint(Graphics g) {
        ...
        if (sudoku != null && !Beans.isDesignTime()) {
            ...
            for (int i = 0; i <= CELL_SIZE; i++){
                if (i  == rowSelected || i == colSelected){
                    g.setColor(Color.orange);
                    
                    }
                g.drawRect(CELL_SIZE * i, CELL_SIZE * i , CELL_SIZE * CELL_SIZE , CELL_SIZE * i);
        ...
        if (getRowSelected() != -1 && getColSelected() != -1) {
            if (evt.getKeyChar() >= '0' && evt.getKeyChar() <= '9') {
                ...
                if (sudoku.isFinished()) {
                    ...
                    ResourceBundle blunde = ResourceBundle.getBundle("res/string", locale);
